...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BETWEEN_SORTED, query = "SELECT m FROM Meal m WHERE m.user=:user AND m.dateTime >=:startDateTime AND m.dateTime < :endDateTime ORDER BY m.dateTime DESC"),
